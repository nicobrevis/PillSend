...
import 'CalendarDialogAlim.dart';
  ...
  void _deleteReservation() async {
    try {
      ...
      DocumentReference reservationRef =
          FirebaseFirestore.instance.collection('alimentos').doc(userUid);
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (BuildContext context) => EntregaAlimentosScreen(),
        ),
      );
        ...
        body: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildBlueBox('Entrega de Alimentos', 24, FontWeight.bold),
